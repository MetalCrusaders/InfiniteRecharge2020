...
public class IntakeSubsystem extends SubsystemBase {
  ...
  public IntakeSubsystem() {
    ...
    m_intakePistons = new DoubleSolenoid(Constants.INTAKE_SOLENOID_DEPLOY, Constants.INTAKE_SOLENOID_RETRACT);

  }

  public void pistonPush(boolean push) {
    if(intakeIsIn) {
